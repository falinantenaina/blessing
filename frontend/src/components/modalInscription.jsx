                ...
                <Select
                  ...
                  onChange={(e) => {
                    ...
                    if (formErrors.niveau_id) {
                      setFormErrors((prev) => ({ ...prev, niveau_id: undefined }));
                    }
                  }}
                  options={[
              ...
              <div className="bg-linear-to-r from-gray-50 to-white p-5 rounded-xl border border-gray-200 mt-2">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <Badge variant="success" size="sm" className="ml-2">
                    {selectedVague.nb_inscrits || 0}/{selectedVague.capacite_max} places
                  </Badge>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-900">
                      {format(new Date(selectedVague.date_debut), "dd MMM yyyy", { locale: fr })}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500">Date fin</p>
                    <p className="text-sm font-medium text-gray-900">
                      {format(new Date(selectedVague.date_fin), "dd MMM yyyy", { locale: fr })}
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <p className="absolute left-3 top-1/3 -translate-y-1/2 w-4 h-4 text-gray-400" >Ar</p>
                  <Input
